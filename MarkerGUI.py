...
class MarkerGUI(QMainWindow):
    ...
    def create_basic_tab(self):
        ...
        self.file_browse_btn = QPushButton("选择文件")
        self.file_browse_btn.clicked.connect(lambda: self.browse_input("file"))
        self.folder_browse_btn = QPushButton("选择文件夹")
        self.folder_browse_btn.clicked.connect(lambda: self.browse_input("folder"))
        
        file_btn_layout.addWidget(self.file_browse_btn)
        file_btn_layout.addWidget(self.folder_browse_btn)
        ...
        file_layout.addRow("输入文件/目录:", self.input_path)
        file_layout.addRow("", self.create_h_widget([self.file_browse_btn, self.folder_browse_btn]))
        file_layout.addRow("输出目录:", self.create_h_widget([self.output_dir, self.output_browse_btn]))
    ...
    def create_advanced_tab(self):
        ...
        config_layout.addRow("选择配置:", self.preset_combo)
